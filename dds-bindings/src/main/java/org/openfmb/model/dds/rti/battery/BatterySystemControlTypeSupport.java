...
public class BatterySystemControlTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "battery::BatterySystemControl";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((255))+1);
        currentAlignment += org.openfmb.model.dds.rti.common.EndDeviceControlTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.common.DateTimeIntervalTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.battery.SequenceOfBatterySystemControlSetPointsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += org.openfmb.model.dds.rti.common.EndDeviceControlTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.common.DateTimeIntervalTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.battery.SequenceOfBatterySystemControlSetPointsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += org.openfmb.model.dds.rti.common.EndDeviceControlTypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.EndDeviceControlType);
        currentAlignment += org.openfmb.model.dds.rti.common.DateTimeIntervalTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.scheduledInterval);
        currentAlignment += org.openfmb.model.dds.rti.battery.SequenceOfBatterySystemControlSetPointsTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.common.EndDeviceControlTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.EndDeviceControlType, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.common.DateTimeIntervalTypeSupport.get_instance().serialize(endpoint_data, typedSrc.scheduledInterval, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.battery.SequenceOfBatterySystemControlSetPointsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.setPoints, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.EndDeviceControlType = (org.openfmb.model.dds.rti.common.EndDeviceControlType)org.openfmb.model.dds.rti.common.EndDeviceControlTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.EndDeviceControlType, src, false, true, endpoint_plugin_qos);     
                typedDst.scheduledInterval = (org.openfmb.model.dds.rti.common.DateTimeInterval)org.openfmb.model.dds.rti.common.DateTimeIntervalTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.scheduledInterval, src, false, true, endpoint_plugin_qos);     
                typedDst.setPoints = (org.openfmb.model.dds.rti.battery.SequenceOfBatterySystemControlSetPoints)org.openfmb.model.dds.rti.battery.SequenceOfBatterySystemControlSetPointsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.setPoints, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.common.EndDeviceControlTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.common.DateTimeIntervalTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.battery.SequenceOfBatterySystemControlSetPointsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
