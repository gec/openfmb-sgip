...
public class  CurveDataTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("curve", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.common.CurveTypeCode.VALUE,1 , false);__i++;
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("common::CurveData",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
