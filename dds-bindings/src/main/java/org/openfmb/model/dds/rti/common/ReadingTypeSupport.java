...
public class ReadingTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "common::Reading";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.common.HexBinary16TypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.common.ReadingTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.common.HexBinary16TypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.common.ReadingTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.common.HexBinary16TypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.qualityFlag);
        currentAlignment += org.openfmb.model.dds.rti.common.ReadingTypeTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.common.HexBinary16TypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.qualityFlag, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.common.ReadingTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.readingType, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.common.DateTimeIntervalTypeSupport.get_instance().serialize(endpoint_data, typedSrc.timePeriod, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.qualityFlag = (org.openfmb.model.dds.rti.common.HexBinary16Type)org.openfmb.model.dds.rti.common.HexBinary16TypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.qualityFlag, src, false, true, endpoint_plugin_qos);     
                typedDst.readingType = (org.openfmb.model.dds.rti.common.ReadingType)org.openfmb.model.dds.rti.common.ReadingTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.readingType, src, false, true, endpoint_plugin_qos);     
                typedDst.timePeriod = (org.openfmb.model.dds.rti.common.DateTimeInterval)org.openfmb.model.dds.rti.common.DateTimeIntervalTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.timePeriod, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.common.HexBinary16TypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.common.ReadingTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
