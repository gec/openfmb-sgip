...
public class ReadingTypeTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "common::ReadingType";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.common.flowdirection.FlowDirectionKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.common.phasecode.PhaseCodeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.common.flowdirection.FlowDirectionKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.common.phasecode.PhaseCodeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += org.openfmb.model.dds.rti.common.flowdirection.FlowDirectionKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.flowDirection);
        currentAlignment += org.openfmb.model.dds.rti.common.phasecode.PhaseCodeKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.common.unitmultiplier.UnitMultiplierKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.multiplier, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeString(typedSrc.name,(255));

            org.openfmb.model.dds.rti.common.unitsymbol.UnitSymbolKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.unit, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.common.flowdirection.FlowDirectionKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.flowDirection, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.common.phasecode.PhaseCodeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.phases, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            typedDst.clear();      
            try{
                typedDst.multiplier = (org.openfmb.model.dds.rti.common.unitmultiplier.UnitMultiplierKind)org.openfmb.model.dds.rti.common.unitmultiplier.UnitMultiplierKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.multiplier, src, false, true, endpoint_plugin_qos);     
                typedDst.name = src.readString((255));
                typedDst.unit = (org.openfmb.model.dds.rti.common.unitsymbol.UnitSymbolKind)org.openfmb.model.dds.rti.common.unitsymbol.UnitSymbolKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.unit, src, false, true, endpoint_plugin_qos);     
                typedDst.flowDirection = (org.openfmb.model.dds.rti.common.flowdirection.FlowDirectionKind)org.openfmb.model.dds.rti.common.flowdirection.FlowDirectionKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.flowDirection, src, false, true, endpoint_plugin_qos);     
                typedDst.phases = (org.openfmb.model.dds.rti.common.phasecode.PhaseCodeKind)org.openfmb.model.dds.rti.common.phasecode.PhaseCodeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.phases, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.common.flowdirection.FlowDirectionKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.common.phasecode.PhaseCodeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
