...
public class  GeneratingUnitTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("maxOperatingP", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.generation.ActivePowerTypeCode.VALUE,3 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("generation::GeneratingUnit",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
