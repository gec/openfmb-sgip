...
public class  GenerationControlModuleTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("generationControl", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.generation.GenerationControlTypeCode.VALUE,3 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("generation::GenerationControlModule",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
