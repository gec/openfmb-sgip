...
public class GenerationReadingModuleTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "generation::GenerationReadingModule";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.generation.GeneratingUnitTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.generation.GenerationStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.generation.SequenceOfGenerationReadingsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.generation.GeneratingUnitTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.generation.GenerationStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.generation.SequenceOfGenerationReadingsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.generation.GeneratingUnitTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.generatingUnit);
        currentAlignment += org.openfmb.model.dds.rti.generation.GenerationStatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.generationStatus);
        currentAlignment += org.openfmb.model.dds.rti.generation.SequenceOfGenerationReadingsTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.generation.GeneratingUnitTypeSupport.get_instance().serialize(endpoint_data, typedSrc.generatingUnit, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.generation.GenerationStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.generationStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.generation.SequenceOfGenerationReadingsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.readings, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.generatingUnit = (org.openfmb.model.dds.rti.generation.GeneratingUnit)org.openfmb.model.dds.rti.generation.GeneratingUnitTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.generatingUnit, src, false, true, endpoint_plugin_qos);     
                typedDst.generationStatus = (org.openfmb.model.dds.rti.generation.GenerationStatus)org.openfmb.model.dds.rti.generation.GenerationStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.generationStatus, src, false, true, endpoint_plugin_qos);     
                typedDst.readings = (org.openfmb.model.dds.rti.generation.SequenceOfGenerationReadings)org.openfmb.model.dds.rti.generation.SequenceOfGenerationReadingsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.readings, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.generation.GeneratingUnitTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.generation.GenerationStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.generation.SequenceOfGenerationReadingsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
