...
public class  LoadForecastModuleTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("forecastSchedule", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.common.ForecastScheduleTypeCode.VALUE,3 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("load::LoadForecastModule",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
