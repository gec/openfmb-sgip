...
public class  LoadReadingModuleTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("readings", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.load.SequenceOfLoadControlReadingsTypeCode.VALUE,3 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("load::LoadReadingModule",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
