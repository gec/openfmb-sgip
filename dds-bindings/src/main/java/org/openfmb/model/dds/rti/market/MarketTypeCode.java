...
public class  MarketTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("marketFactors", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.market.SequenceOfMarketMarketFactorsTypeCode.VALUE,13 , false);__i++;
        sm[__i]=new  StructMember("marketRuns", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.market.SequenceOfMarketMarketRunsTypeCode.VALUE,14 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("market::Market",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
