...
public class RecloserControlModuleTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "recloser::RecloserControlModule";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.recloser.RecloserTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.recloser.RecloserControlTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.recloser.RecloserTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.recloser.RecloserControlTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.recloser.RecloserTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.recloser);
        currentAlignment += org.openfmb.model.dds.rti.recloser.RecloserControlTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.recloser.RecloserTypeSupport.get_instance().serialize(endpoint_data, typedSrc.recloser, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.recloser.RecloserControlTypeSupport.get_instance().serialize(endpoint_data, typedSrc.recloserControl, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.recloser = (org.openfmb.model.dds.rti.recloser.Recloser)org.openfmb.model.dds.rti.recloser.RecloserTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.recloser, src, false, true, endpoint_plugin_qos);     
                typedDst.recloserControl = (org.openfmb.model.dds.rti.recloser.RecloserControl)org.openfmb.model.dds.rti.recloser.RecloserControlTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.recloserControl, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.recloser.RecloserTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.recloser.RecloserControlTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
