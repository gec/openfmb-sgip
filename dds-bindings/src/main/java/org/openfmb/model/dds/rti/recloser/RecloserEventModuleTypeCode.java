...
public class  RecloserEventModuleTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("recloserStatus", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.recloser.RecloserStatusTypeCode.VALUE,3 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("recloser::RecloserEventModule",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
