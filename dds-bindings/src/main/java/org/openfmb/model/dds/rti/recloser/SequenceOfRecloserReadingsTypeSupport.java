...
public class SequenceOfRecloserReadingsTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "recloser::SequenceOfRecloserReadings";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.common.ReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.recloser.MaxLengthRecloserReadings.VALUE)));
        if (include_encapsulation) {
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.common.ReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.recloser.MaxLengthRecloserReadings.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            org.openfmb.model.dds.rti.common.ReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.recloser.MaxLengthRecloserReadings.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
