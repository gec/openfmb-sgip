...
public class  SolarControlModuleTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("solarControl", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.solar.SolarControlTypeCode.VALUE,2 , false);__i++;
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("solar::SolarControlModule",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
