...
public class  SolarReadingModuleTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("readings", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.solar.SequenceOfSolarReadingsTypeCode.VALUE,2 , false);__i++;
        ...
        sm[__i]=new  StructMember("solarInverterStatus", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.solar.SolarInverterStatusTypeCode.VALUE,4 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("solar::SolarReadingModule",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
